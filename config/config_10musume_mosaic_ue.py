...
#########################設定#####################
# プロジェクト名
project_name = "10musume_mosaic_ue"
# 出力ディレクトリ
#base_output_dir = "/Users/radmanesh/Desktop/davinci_render"  # 出力先のフォルダを指定
base_output_dir=r"D:\ダウンロード\10musume_all\10musume_mosaic_ue"
#フォルダパス  フォルダ番号を除いたパス　番号は001のゼロ埋めで統一
#folder_path="/Users/radmanesh/Desktop/davimp4/mu-"
folder_path=r"D:\ダウンロード\10musume_all\10musume_mosaic_base_ue\mu-"
# 新規で作成するフォルダーの名前
new_folder_name = "Render_10musume"  # 新しいフォルダの名前
#toomany_importとzero_importを書き出すフォルダパス
text_path=r"D:\ダウンロード\10musume_all\10musume_mosaic_ue"
#レンダリング開始位置
markln=1800
#レンダリング終了位置
markout=270
#ファイル名の接頭辞 
filePrefix="10musume_mosaic_ue"
#ズーム設定
zoomx=1.0 # 水平方向のズーム
zoomy=1.0 # 垂直方向のズーム
# 位置を変更
